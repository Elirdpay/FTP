...
function CartPage() {
    ...
    const [singleItem, setSingleItem] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspaces$2f$FTP$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const load = async ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspaces$2f$FTP$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartPage.useEffect": ()=>{
            const onStorage = {
                "CartPage.useEffect.onStorage": (_e)=>{
                    load();
                }
            }["CartPage.useEffect.onStorage"];
            window.addEventListener('storage', onStorage);
            return ({
                "CartPage.useEffect": ()=>window.removeEventListener('storage', onStorage)
            })["CartPage.useEffect"];
        }
    }["CartPage.useEffect"], []);
    ...
    async function removeItem(pid) {
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$workspaces$2f$FTP$2f$src$2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])('Сеть: не удалось удалить товар');
        }
        await load();
        try {
            const cnt = (await (await fetch(`/api/me/cart`, {
...
_s(CartPage, "Y3iaidcYM+Upzo8Jk+EphOm8Wis=");
_c1 = CartPage;
var _c, _c1;
...
//# sourceMappingURL=workspaces_FTP_src_a3f891b4._.js.map
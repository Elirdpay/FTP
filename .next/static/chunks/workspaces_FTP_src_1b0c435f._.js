...
function AuthModal({ open, onClose }) {
    ...
    async function submit(e) {
        ...
        if (mode === 'login') {
            ...
            const res = await fetch((__TURBOPACK__imported__module__$5b$project$5d2f$workspaces$2f$FTP$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_BASE || 'http://localhost:8000') + '/token', {
                method: 'POST',
                body: data
            });
            if (!res.ok) {
        ...
        // register
        const res = await fetch((__TURBOPACK__imported__module__$5b$project$5d2f$workspaces$2f$FTP$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_BASE || 'http://localhost:8000') + '/register', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
_s(AuthModal, "fb0Y8+aXc5ANZFCCH60/Td/QYv4=");
_c = AuthModal;
var _c;
...
//# sourceMappingURL=workspaces_FTP_src_1b0c435f._.js.map
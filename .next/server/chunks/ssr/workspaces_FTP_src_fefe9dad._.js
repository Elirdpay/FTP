...
function CartPage() {
    ...
    async function removeItem(pid) {
        ...
        await fetch((process.env.NEXT_PUBLIC_API_BASE || 'http://localhost:8000') + `/me/cart/remove?product_id=${encodeURIComponent(pid)}`, {
            method: 'POST',
            headers: {
                Authorization: `Bearer ${token}`
            }
...
//# sourceMappingURL=workspaces_FTP_src_fefe9dad._.js.map
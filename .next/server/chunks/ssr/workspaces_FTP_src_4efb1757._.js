...
function LoginForm({ onSuccess }) {
    ...
    async function handleLogin(e) {
        ...
        try {
            let res;
            try {
                res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$workspaces$2f$FTP$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE"]}/auth/login`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                ...
                console.error('fetch /auth/login failed', e);
...
function RegisterForm({ onSuccess }) {
    ...
    async function handleRegister(e) {
        ...
        try {
            let res;
            try {
                res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$workspaces$2f$FTP$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE"]}/auth/register`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
            ...
            // попытка авто-логина
            try {
                const lr = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$workspaces$2f$FTP$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_BASE"]}/auth/login`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
...
//# sourceMappingURL=workspaces_FTP_src_4efb1757._.js.map